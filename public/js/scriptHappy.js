let songIndex = 1;
let audioElement = new Audio("/songs/Happy/1.mp3");
...
let songs = [
    { songName: "Baby", filePath: "/songs/Happy/1.mp3", coverPath: "/images/Happy1.jpg" },
    { songName: "Dil Dhadakne Do", filePath: "/songs/Happy/2.mp3", coverPath: "/images/Happy2.jpeg" },
    { songName: "Senorita", filePath: "/songs/Happy/3.mp3", coverPath: "/images/Happy3.jpg" },
    { songName: "Swag Se Swagat", filePath: "/songs/Happy/4.mp3", coverPath: "/images/Happy4.jpg" },
    { songName: "Shake It Off", filePath: "/songs/Happy/5.mp3", coverPath: "/images/Happy5.jpeg" }
];
...
audioElement.addEventListener('ended', () => {
    ...
    audioElement.src = `/songs/Happy/${songIndex}.mp3`;
    masterSongName.innerText = songs[songIndex - 1].songName;
