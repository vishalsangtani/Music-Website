...
let songs = [
    { songName: "Dil Nu", filePath: "/songs/Sleep/1.mp3", coverPath: "/images/Sleep1.jpg" },
    { songName: "Is There Someone Else", filePath: "/songs/Sleep/2.mp3", coverPath: "/images/Sleep2.jpg" },
    { songName: "Peace", filePath: "/songs/Sleep/3.mp3", coverPath: "/images/Sleep3.jpg" },
    { songName: "Reminder", filePath: "/songs/Sleep/4.mp3", coverPath: "/images/Sleep4.jpg" },
    { songName: "Zara Paas To Baitho", filePath: "/songs/Sleep/5.mp3", coverPath: "/images/Sleep5.jpg" }
];
...
audioElement.addEventListener('ended', () => {
    ...
    audioElement.src = `/songs/Sleep/${songIndex}.mp3`;
    masterSongName.innerText = songs[songIndex - 1].songName;
