let songIndex = 1;
let audioElement = new Audio("/songs/Gym/1.mp3");
...
let songs = [
    { songName: "295", filePath: "/songs/Gym/1.mp3", coverPath: "/images/Gym1.jpg" },
    { songName: "G.O.A.T", filePath: "/songs/Gym/2.mp3", coverPath: "/images/Gym2.jpg" },
    { songName: "Insane", filePath: "/songs/Gym/3.mp3", coverPath: "/images/Gym3.jpg" },
    { songName: "So High", filePath: "/songs/Gym/4.mp3", coverPath: "/images/Gym4.jpg" },
    { songName: "Starboy", filePath: "/songs/Gym/5.mp3", coverPath: "/images/Gym5.jpg" }
];
...
audioElement.addEventListener('ended', () => {
    ...
    audioElement.src = `/songs/Gym/${songIndex}.mp3`;
    masterSongName.innerText = songs[songIndex - 1].songName;
