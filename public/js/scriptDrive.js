let songIndex = 1;
let audioElement = new Audio("/songs/Drive/1.mp3");
...
let songs = [
    { songName: "Khaabon Ke Parinday", filePath: "/songs/Drive/1.mp3", coverPath: "/images/Drive1.jpg" },
    { songName: "Ilahi", filePath: "/songs/Drive/2.mp3", coverPath: "/images/Drive2.jpg" },
    { songName: "Let Me Love You", filePath: "/songs/Drive/3.mp3", coverPath: "/images/Drive3.jpeg" },
    { songName: "Te Amo", filePath: "/songs/Drive/4.mp3", coverPath: "/images/Drive4.jpeg" },
    { songName: "When I See You Again", filePath: "/songs/Drive/5.mp3", coverPath: "/images/Drive5.jpeg" }
];
...
audioElement.addEventListener('ended', () => {
    ...
    audioElement.src = `/songs/Drive/${songIndex}.mp3`;
    masterSongName.innerText = songs[songIndex - 1].songName;
