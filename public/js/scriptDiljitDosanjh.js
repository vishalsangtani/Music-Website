let songIndex = 1;
let audioElement = new Audio("/songs/Diljit_Dosanjh/1.mp3");
...
let songs = [
    { songName: "G.O.A.T", filePath: "/songs/Diljit_Dosanjh/1.mp3", coverPath: "/images/Diljit1.jpg" },
    { songName: "Jugni", filePath: "/songs/Diljit_Dosanjh/2.mp3", coverPath: "/images/Diljit2.jpg" },
    { songName: "Koka", filePath: "/songs/Diljit_Dosanjh/3.mp3", coverPath: "/images/Diljit3.jpg" },
    { songName: "Lemonade", filePath: "/songs/Diljit_Dosanjh/4.mp3", coverPath: "/images/Diljit4.jpg" },
    { songName: "Nazarey", filePath: "/songs/Diljit_Dosanjh/5.mp3", coverPath: "/images/Diljit5.jpg" }
];
...
audioElement.addEventListener('ended', () => {
    ...
    audioElement.src = `/songs/Diljit_Dosanjh/${songIndex}.mp3`;
    masterSongName.innerText = songs[songIndex - 1].songName;
