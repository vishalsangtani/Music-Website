...
let songs = [
    { songName: "Aa Paas Aa Ankahee", filePath: "/songs/Hindi/1.mp3", coverPath: "/images/Hindi1.jpg" },
    { songName: "Abhi Kuch Dino Se", filePath: "/songs/Hindi/2.mp3", coverPath: "/images/Hindi2.jpg" },
    { songName: "Ala Barfi", filePath: "/songs/Hindi/3.mp3", coverPath: "/images/Hindi3.jpg" },
    { songName: "Aur Tanha", filePath: "/songs/Hindi/4.mp3", coverPath: "/images/Hindi4.jpg" },
    { songName: "Daata Tu", filePath: "/songs/Hindi/5.mp3", coverPath: "/images/Hindi5.jpg" }
];
...
audioElement.addEventListener('ended', () => {
    ...
    audioElement.src = `/songs/Hindi/${songIndex}.mp3`;
    masterSongName.innerText = songs[songIndex - 1].songName;
