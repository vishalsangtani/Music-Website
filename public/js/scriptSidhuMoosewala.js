let songIndex = 1;
let audioElement = new Audio("/songs/Sidhu_Moosewala/1.mp3");
...
let songs = [
    { songName: "295", filePath: "/songs/Sidhu_Moosewala/1.mp3", coverPath: "/images/Sidhu1.jpg" },
    { songName: "Baapu", filePath: "/songs/Sidhu_Moosewala/2.mp3", coverPath: "/images/Sidhu2.jpg" },
    { songName: "Old Skool", filePath: "/songs/Sidhu_Moosewala/3.mp3", coverPath: "/images/Sidhu3.jpg" },
    { songName: "Saab", filePath: "/songs/Sidhu_Moosewala/4.mp3", coverPath: "/images/Sidhu4.jpg" },
    { songName: "So High", filePath: "/songs/Sidhu_Moosewala/5.mp3", coverPath: "/images/Sidhu5.jpg" }
];
...
audioElement.addEventListener('ended', () => {
    ...
    audioElement.src = `/songs/Sidhu_Moosewala/${songIndex}.mp3`;
    masterSongName.innerText = songs[songIndex - 1].songName;
