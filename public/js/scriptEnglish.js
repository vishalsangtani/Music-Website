let songIndex = 1;
let audioElement = new Audio("/songs/English/1.mp3");
...
let songs = [
    { songName: "Levitating", filePath: "/songs/English/1.mp3", coverPath: "/images/English1.jpg" },
    { songName: "Peace", filePath: "/songs/English/2.mp3", coverPath: "/images/English2.jpg" },
    { songName: "Blinding Lights", filePath: "/songs/English/3.mp3", coverPath: "/images/English3.jpg" },
    { songName: "Reminder", filePath: "/songs/English/4.mp3", coverPath: "/images/English4.jpg" },
    { songName: "Starboy", filePath: "/songs/English/5.mp3", coverPath: "/images/English5.jpg" }
];
...
audioElement.addEventListener('ended', () => {
    ...
    audioElement.src = `/songs/English/${songIndex}.mp3`;
    masterSongName.innerText = songs[songIndex - 1].songName;
