let songIndex = 1;
let audioElement = new Audio("/songs/Taylor_Swift/1.mp3");
...
let songs = [
    { songName: "Betty", filePath: "/songs/Taylor_Swift/1.mp3", coverPath: "/images/Taylor1.jpg" },
    { songName: "Cardigan", filePath: "/songs/Taylor_Swift/2.mp3", coverPath: "/images/Taylor2.jpg" },
    { songName: "Hoaxx", filePath: "/songs/Taylor_Swift/3.mp3", coverPath: "/images/Taylor3.jpg" },
    { songName: "Mad Woman", filePath: "/songs/Taylor_Swift/4.mp3", coverPath: "/images/Taylor4.jpg" },
    { songName: "Peace", filePath: "/songs/Taylor_Swift/5.mp3", coverPath: "/images/Taylor5.jpg" }
];
...
audioElement.addEventListener('ended', () => {
    ...
    audioElement.src = `/songs/Taylor_Swift/${songIndex}.mp3`;
    masterSongName.innerText = songs[songIndex - 1].songName;
