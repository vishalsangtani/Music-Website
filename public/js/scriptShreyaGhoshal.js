let songIndex = 1;
let audioElement = new Audio("/songs/Shreya_Ghoshal/1.mp3");
...
let songs = [
    { songName: "Aa Paas Aa Ankahee", filePath: "/songs/Shreya_Ghoshal/1.mp3", coverPath: "/images/Shreya1.jpg" },
    { songName: "Aahi Re Mahi ", filePath: "/songs/Shreya_Ghoshal/2.mp3", coverPath: "/images/Shreya2.jpg" },
    { songName: "Daata Tu", filePath: "/songs/Shreya_Ghoshal/3.mp3", coverPath: "/images/Shreya3.jpg" },
    { songName: "Hume Tumse Pyaar Kitna ", filePath: "/songs/Shreya_Ghoshal/4.mp3", coverPath: "/images/Shreya4.jpg" },
    { songName: "Zara Paas To Baitho Shreya Ghoshal", filePath: "/songs/Shreya_Ghoshal/5.mp3", coverPath: "/images/Shreya5.jpg" }
];
...
audioElement.addEventListener('ended', () => {
    ...
    audioElement.src = `/songs/Shreya_Ghoshal/${songIndex}.mp3`;
    masterSongName.innerText = songs[songIndex - 1].songName;
