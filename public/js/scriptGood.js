let songIndex = 1;
let audioElement = new Audio("/songs/Good/1.mp3");
...
let songs = [
    { songName: "Ala Barfi", filePath: "/songs/Good/1.mp3", coverPath: "/images/Good1.jpg" },
    { songName: "Levitating", filePath: "/songs/Good/2.mp3", coverPath: "/images/Good2.jpg" },
    { songName: "Nazarey", filePath: "/songs/Good/3.mp3", coverPath: "/images/Good3.jpg" },
    { songName: "Old Skool", filePath: "/songs/Good/4.mp3", coverPath: "/images/Good4.jpg" },
    { songName: "Summer High", filePath: "/songs/Good/5.mp3", coverPath: "/images/Good5.jpg" }
];
...
audioElement.addEventListener('ended', () => {
    ...
    audioElement.src = `/songs/Good/${songIndex}.mp3`;
    masterSongName.innerText = songs[songIndex - 1].songName;
