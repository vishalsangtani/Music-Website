let songIndex = 1;
let audioElement = new Audio("/songs/Dua_Lipa/1.mp3");
...
let songs = [
    { songName: "Be The One", filePath: "/songs/Dua_Lipa/1.mp3", coverPath: "/images/Dua1.jpg" },
    { songName: "Dance The Night", filePath: "/songs/Dua_Lipa/2.mp3", coverPath: "/images/Dua2.png" },
    { songName: "Levitating", filePath: "/songs/Dua_Lipa/3.mp3", coverPath: "/images/Dua3.jpg" },
    { songName: "New Rules", filePath: "/songs/Dua_Lipa/4.mp3", coverPath: "/images/Dua4.jpg" },
    { songName: "No Lie", filePath: "/songs/Dua_Lipa/5.mp3", coverPath: "/images/Dua5.jpg" }
];
...
audioElement.addEventListener('ended', () => {
    ...
    audioElement.src = `/songs/Dua_Lipa/${songIndex}.mp3`;
    masterSongName.innerText = songs[songIndex - 1].songName;
