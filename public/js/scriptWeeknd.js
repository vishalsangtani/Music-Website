let songIndex = 1;
let audioElement = new Audio("/songs/Weeknd/1.mp3");
...
let songs = [
    { songName: "Is There Someone Else?", filePath: "/songs/Weeknd/1.mp3", coverPath: "/images/Weeknd1.jpg" },
    { songName: "Blinding Lights", filePath: "/songs/Weeknd/2.mp3", coverPath: "/images/Weeknd2.jpg" },
    { songName: "Die For You", filePath: "/songs/Weeknd/3.mp3", coverPath: "/images/Weeknd3.jpg" },
    { songName: "Reminder", filePath: "/songs/Weeknd/4.mp3", coverPath: "/images/Weeknd4.jpg" },
    { songName: "Starboy", filePath: "/songs/Weeknd/5.mp3", coverPath: "/images/Weeknd5.jpg" }
];
...
audioElement.addEventListener('ended', () => {
    ...
    audioElement.src = `/songs/Weeknd/${songIndex}.mp3`;
    masterSongName.innerText = songs[songIndex - 1].songName;
