let songIndex = 1;
let audioElement = new Audio("/songs/Pritam/1.mp3");
...
let songs = [
    { songName: "Abhi Kuch Dino Se", filePath: "/songs/Pritam/1.mp3", coverPath: "/images/Pritam1.jpg" },
    { songName: "Ae Ganpat Baja Na", filePath: "/songs/Pritam/2.mp3", coverPath: "/images/Pritam2.jpg" },
    { songName: "Ala Barfi", filePath: "/songs/Pritam/3.mp3", coverPath: "/images/Pritam3.jpg" },
    { songName: "Alvida", filePath: "/songs/Pritam/4.mp3", coverPath: "/images/Pritam4.jpg" },
    { songName: "Aur Tanha", filePath: "/songs/Pritam/5.mp3", coverPath: "/images/Pritam5.jpg" }
];
...
audioElement.addEventListener('ended', () => {
    ...
    audioElement.src = `/songs/Pritam/${songIndex}.mp3`;
    masterSongName.innerText = songs[songIndex - 1].songName;
